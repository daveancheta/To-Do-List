        ...
        <div class="form-container">
            ...
            <form method="POST" action="">
                ...
                <div class="input-group mb-4">
                    ...
                    <input class="form-control" type="password" id="password" name="password" placeholder="Enter your password" required autocomplete="off">
                </div>
                
                <div class="info-tip">
                    Tip: Any username will work, but make sure it's unique.
                </div>
                <button class="btn-green" type="submit" name="submit">Sign Up</button>
            </form>
        </div>
    </div>
</body>
